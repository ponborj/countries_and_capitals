...
class MainController extends Controller
{
    ...
    public function prepareGame(Request $request)
    {
        ...
        $request->validate(
            ...
            [
                ...
                'total_questions.integer' => 'O número de questões deve ser um valor numérico inteiro',
                'total_questions.min' => 'O número mínimo de questões é :min',
                'total_questions.max' => 'O número máximo de questões é :max'
            ]
        );

        // obtem numero de questoes
        $total_questions = intval($request->input('total_questions'));

        // prepara a estrutura
        $quiz = $this->prepareQuiz($total_questions);

        // salva o quiz na sessao
        session()->put([
            //
            'quiz' => $quiz,
    ...
    public function game(): View
    {
        ...
        // prepara a resposta para a view
